...
public class CursorTest extends JFrame {
 ...
 private static final long serialVersionUID = 1L; 
    ...
    private final String LABEL_TEXT = "The current cursor name is: ";
    private int [] cursors;
...
*/    
    ...
    //use an anonymous array to perform the initialization
        ...
        /*******************************/
        cursors = new int[]{Cursor.DEFAULT_CURSOR, Cursor.CROSSHAIR_CURSOR,Cursor.TEXT_CURSOR,
            Cursor.WAIT_CURSOR,Cursor.N_RESIZE_CURSOR,Cursor.S_RESIZE_CURSOR,Cursor.E_RESIZE_CURSOR,Cursor.SW_RESIZE_CURSOR,
            Cursor.SE_RESIZE_CURSOR,Cursor.NW_RESIZE_CURSOR,Cursor.HAND_CURSOR,Cursor.MOVE_CURSOR};
    ...
    label_02 = new JLabel(LABEL_TEXT + Cursor.getDefaultCursor().getName());
	pane = new JPanel();
...
*/   
    ...
    ++cursorCounter;
    Cursor newCursor = Cursor.getPredefinedCursor(cursors[cursorCounter]);/* add code here */
   

    // set the button cursor here: call setCursor(newCursor) on the button
    /* add the code here */
    button.setCursor(newCursor);
    //set the label text here: use getName to get the name of the cursor
        
     label_02.setText(LABEL_TEXT + newCursor.getName());

...
import JSFPages.util.JsfUtil;
import JSFPages.util.PaginationHelper;
import cst8218.desj0270.sprite.SpriteFacade;
...
/**
 * SpriteController: Handles user interaction with the JSF pages
 * Session bean
 * 
 * @author fmdes
 * @version 1.0
...
public class SpriteController implements Serializable {
    ...
    /*
    * Class ColorConverter to convert color to string and vice-versa.
    * 
    */
    ...
    public static class ColorConverter implements Converter {         
        ...
        /**
        * getAsObject
        * This method converts a string to a color and returns it.
        * @param facesContext passes the context
        * @param component passes the UI component
        * @param value passes the string to convert
        * @returns color
        */
        @Override
        public Color getAsObject(FacesContext facesContext, UIComponent component, String value) {
            
                String[] colorString = value.split(",");
                Color colorExtracted = new Color(
                        Integer.parseInt(colorString[0]), 
        ...
        /**
        * getAsString
        * This method converts a color to a string and returns it.
        * @param facesContext passes the context
        * @param component passes the UI component
        * @param value passes the string to convert
        * @returns string

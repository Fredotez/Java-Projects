 ...
 */
public class FredericCelsiusConverterGUI extends javax.swing.JFrame {

    /**
     * Creates new form FredericCelsiusConverterGUI
     */
    public FredericCelsiusConverterGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Frederic Celcius Converter");

        tempTextField.setText("TExtField");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FredericCelsiusConverterGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FredericCelsiusConverterGUI().setVisible(true);
            }
        });
    }
